...
function create_witch_sprite () {
    witch_sprite = sprites.create(assets.image`witch_idle_1`, SpriteKind.Player)
    anim = animation.createAnimation(ActionKind.Idle, 1000)
    anim.addAnimationFrame(assets.image`witch_idle_1`)
